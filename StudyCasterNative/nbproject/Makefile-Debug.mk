...
${OBJECTDIR}/windowlib.o: nbproject/Makefile-${CND_CONF}.mk windowlib.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -Werror  -MMD -MP -MF $@.d -o ${OBJECTDIR}/windowlib.o windowlib.c
...
${TESTDIR}/tests/windowlibtest.o: tests/windowlibtest.c 
	...
	${RM} $@.d
	$(COMPILE.c) -g -Werror -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/tests/windowlibtest.o tests/windowlibtest.c
...
${OBJECTDIR}/windowlib_nomain.o: ${OBJECTDIR}/windowlib.o windowlib.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g -Werror  -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/windowlib_nomain.o windowlib.c;\
	else  \

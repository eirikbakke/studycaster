...
public class OldStatusFrame extends javax.swing.JFrame {
  ...
  private static Image getIconImage(String postFix) {
    return Toolkit.getDefaultToolkit().getImage(OldStatusFrame.class.getClassLoader().getResource(
  ...
  public OldStatusFrame(String instructions) {

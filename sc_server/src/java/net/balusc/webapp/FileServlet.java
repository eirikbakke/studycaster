/*
 *  Modifications for StudyCaster (by Eirik Bakke):
 ...
 */
@WebServlet(name = "FileServlet", urlPatterns = {"/download/*"})
public class FileServlet extends HttpServlet {
      ...
      boolean content) throws IOException, ServletException
  {
    ...
    String contentType = ServletUtil.getMimeType(getServletContext(), fileName);

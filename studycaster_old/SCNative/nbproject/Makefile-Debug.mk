...
${OBJECTDIR}/NativeLibrary.o: NativeLibrary.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -Wall -D_JNI_IMPLEMENTATION_ -I/C/Program\ Files\ \(x86\)/Java/jdk1.5.0_22/include -I/C/Program\ Files\ \(x86\)/Java/jdk1.5.0_22/include/win32 -I.  -MMD -MP -MF $@.d -o ${OBJECTDIR}/NativeLibrary.o NativeLibrary.c
